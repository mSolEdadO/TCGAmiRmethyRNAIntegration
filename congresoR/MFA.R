...
pdf("PCAomics.pdf")
fviz_pca_ind(PCAomics$methy,geom="point",habillage=design$subtype,palette=ggsci::pal_lancet("lanonc")(5),title="Methy",pch=19)
fviz_eig(PCAomics$methy, addlabels = TRUE,title="Methy")
fviz_pca_ind(PCAomics$mirna,geom="point",habillage=design$subtype,palette=ggsci::pal_lancet("lanonc")(5),pch=19,title="miRNA")
fviz_eig(PCAomics$mirna, addlabels = TRUE,title="miRNA")
fviz_pca_ind(PCAomics$rna,geom="point",habillage=design$subtype,palette=ggsci::pal_lancet("lanonc")(5),pch=19,title="mRNA")
